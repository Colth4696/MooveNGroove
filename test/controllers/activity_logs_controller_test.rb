...
class ActivityLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create activity_log" do
    assert_difference('ActivityLog.count') do
      post activity_logs_url, params: { activity_log: { activity_type: @activity_log.activity_type, date: @activity_log.date, duration: @activity_log.duration, user_id: @activity_log.user_id } }
    end
  ...
  test "should update activity_log" do
    patch activity_log_url(@activity_log), params: { activity_log: { activity_type: @activity_log.activity_type, date: @activity_log.date, duration: @activity_log.duration, user_id: @activity_log.user_id } }
